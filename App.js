async function getDashRequest (url='/data.json') {
    ...
    createMarkup() {
        ...
        <article class="tracking-card">
          <header class="tracking-card__header">
            ...
            <img src="/images/icon-ellipsis.svg" alt="" class="tracking-cars__menu">
          </header>
...
document.addEventListener('DOMContentLoaded' , () => {
    ...
    getDashRequest().then(resp => {
        const activities = resp.map(activity => new DashboardItem(activity))
